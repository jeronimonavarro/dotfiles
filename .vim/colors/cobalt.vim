...
hi Special      ctermfg=7 ctermbg=NONE
...
hi htmlTagName  ctermfg=3 ctermbg=NONE
hi Identifier   ctermfg=7 ctermbg=NONE
hi Statement    ctermfg=7 ctermbg=NONE
hi Boolean      ctermfg=1 ctermbg=NONE
hi PreProc      ctermfg=5 ctermbg=NONE cterm=bold
hi Type         ctermfg=6 ctermbg=NONE
hi Function     ctermfg=7 ctermbg=NONE cterm=bold
hi Repeat       ctermfg=3 ctermbg=NONE cterm=bold
hi Operator     ctermfg=7 ctermbg=NONE
hi Error        ctermfg=1 ctermbg=NONE
hi TODO         ctermfg=6 ctermbg=NONE cterm=bold
hi LineNR       ctermfg=4 ctermbg=8
hi CursorLineNR ctermfg=4 ctermbg=8 cterm=bold

hi Visual          ctermfg=8 ctermbg=5
hi SpecialKey      ctermfg=4 ctermbg=NONE
hi NonText         ctermfg=8 ctermbg=NONE
hi ExtraWhitespace             ctermbg=NONE
hi MatchParen      ctermfg=3 ctermbg=8
